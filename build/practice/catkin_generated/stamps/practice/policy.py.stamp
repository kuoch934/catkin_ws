...
if __name__ == '__main__':
    ...
    try:
        # 嘗試載入 policy
        policy = LoadedPolicy()
        rospy.loginfo(f"成功載入 policy: obs_dim={policy.obs_dim}, act_dim={policy.act_dim}")
        
        rospy.spin()  # 先不做任何 pub/sub，單純保持 node 存活
...
# from Policyfile import policy_runner
# LoadedPolicy = policy_runner.LoadedPolicy
